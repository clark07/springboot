package com.cs.test.restcontroller;
...
@Api(value = "API接口名称", description = "API接口描述")
public class RestControllerDemo {
	...
	public List<User> getUserList() {
		List<User> r = new ArrayList<User>(users.values()); return r;
	}
	...
	public String putUser(@PathVariable Long id, @RequestBody User user) {
		User u = users.get(id); u.setName(user.getName()); u.setAge(user.getAge()); users.put(id, u); return "success";
	}
